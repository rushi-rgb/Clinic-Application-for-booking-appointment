        ...
        <div class="container">
            ...
            <nav id="nav-menu-container">
                <ul class="nav-menu">
                    ...
                    @guest
                        <li><a href="{{ route('admin.login') }}">Login Clinic</a></li>
                        <li><a href="{{ route('doctor.login') }}">Login Doctor</a></li>
                    @endguest 
                    @auth
  ...
  ============================-->
    <section id="hero" class="wow fadeIn">
        <div class="hero-container">
            ...
            <br>
            <h1>CLINIC</h1>
            <h2>Medical Consultancies</h2>
            <img src="img/hero-img.jpg" alt="Hero Imgs">

            @guest
                <div class="btns">
                    <a href="{{ route('user.login') }}" class="btn-get-started scrollto">Login Patient</a>
                    <a href="{{ route('user.register') }}" class="btn-get-started scrollto">Register Patient</a>
                </div> 
            @endguest
        </div>
    </section><!-- #hero -->
