...
<body>
    ...
    <section class="container text-center">
        ...
        <h2 class="doctorh1">Select Doctors</h2>
        <table class="table">
            <thead>
                <tr>
                    <th scope="col">#</th>
                ...
                @foreach ($doctor as $d)
                    <form action="bookapt" method="post">
                        ...
                        <tr>
                            ...
                            <td>{{ $d->doctor_name }}</td>
                            <td>{{ $d->designation }}</td>
                            <input type="hidden" value="{{ session()->get('patientid') }}" name="patientid">
                            <input type="hidden" value="{{ $d->id }}" name="doctorid">
                            <td><button
                                        class="btn btn-primary" type="submit">Book Appointment</button></td>
                        </tr>
                    </form>
