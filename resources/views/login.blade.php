            ...
            <div class="row justify-content-center">
                @if (session('errlogin'))
                    <div class="alert alert-warning alert-dismissible fade show" role="alert">
                        <strong>Failed To Login!</strong> Please enter Correct Contact and Password.
                    </div>
                @endif
                @if (session('succlogin'))
                    <div class="alert alert-success alert-dismissible fade show" role="alert">
                        <strong>Registered Successfully!</strong> Please Login
                    </div>
                @endif
                <form action="{{ route('user.login') }}" style="border:1px solid #ccc" method="post">
                    @csrf
                    <div class="container">
