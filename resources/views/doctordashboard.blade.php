...
<body>
  ...
  ============================-->
    ...
    <section class="container text-center">
        ...
        <h2 class="doctorh1">Total Appoinments</h2>
        {{-- <a href="{{ route('doctor.create') }}"><button class="btn btn-primary mb-3">Add Doctor</button></a> --}}
        @if (session('doctor-added'))
            <div class="alert alert-success alert-dismissible fade show" role="alert">
                <strong>Doctor Added Succesfully!</strong>
            </div>
        @endif
            ...
            <tbody>
                    ...
                    <tr>
                         ...
                         <td>{{ $appointment->problem }}</td>
                             ...
                             @else
                                <td>
                                    <form action="{{ route('confirm.appointments') }}" method="post">
                                        @csrf
